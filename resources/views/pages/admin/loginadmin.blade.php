...
<div class="w3layouts-main" style="border-radius: 5rem; background:#2F4F4F; opacity: 0.7;">
	...
	?>
		<form action="{{URL::to('/homeadmin')}}" >
			{{csrf_field()}}
			<input type="email" class="ggg" name="email_admin" placeholder="Điền email" required="" style="border-radius:2rem">
			<input type="password" class="ggg" name="password_admin" placeholder="Điền mật khẩu" required="" style="border-radius:2rem">
			<span><input type="checkbox" /> Ghi nhớ</span>
			<h6><a href="#">Quên mật khẩu?</a></h6>
				<div class="clearfix"></div>
				<input type="submit" value="Đăng nhập" name="login" style="border-radius:1rem">
		</form>
