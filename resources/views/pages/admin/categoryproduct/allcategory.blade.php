      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{URL::to('/editcategory/'.$allcate->id)}}" class="active" ui-toggle-class=""><i class="fa fa-pencil-square-o text-success text-active"></i>
              </a>
              <a href="{{URL::to('/deletecategory/'.$allcate->id)}}" class="active" ui-toggle-class=""><i class="fa fa-times text-danger text"></i>
              </a>
