...
<div class="brand" style="background-color:black;">
    <a href="#" class="logo" style="font-weight: bolder;">
        CHERIS
    </a>
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span class="username">Admin Cheris</span>
                <b class="caret"></b>
            </a>
            <ul class="dropdown-menu extended logout">
                <li><a href="#"><i class=" fa fa-suitcase"></i>Profile</a></li>
                <li><a href="#"><i class="fa fa-cog"></i> Settings</a></li>
                <li><a href="{{URL::to('/loginuser')}}"><i class="fa fa-key"></i> Log Out</a></li>
            </ul>
        </li>
        ...
        <div class="market-updates">
            ...
            <div class="agile-last-grids">
                <div class="col-md-4 agile-last-left">
                    <div class="agile-last-grid"  style="height: 45rem;">
